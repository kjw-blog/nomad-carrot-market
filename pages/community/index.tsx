    ...
    <div className="py-16 px-4 space-y-8">
      {[1, 2, 3, 4, 5, 6].map((_, i) => (
        <div key={i} className="flex flex-col items-start cursor-pointer">
          <span className="flex items-center px-2.5 py-0.5 rounded-full text-sm font-semibold text-gray-800 bg-gray-100">
            동네질문
          </span>
          ...
          <div className="mt-5 flex items-center justify-between w-full text-gray-500 text-sm font-semibold">
            <span>니꼬</span>
            <span>18시간 전</span>
          </div>
          <div className="flex space-x-5 mt-3 text-gray-700 text-sm py-2.5 border-t border-b-2 w-full">
