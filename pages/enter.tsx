      ...
      <div className="mt-8">
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <div className="-top-3 relative text-center">
          ...
          <div className="grid grid-cols-2 gap-3 mt-2">
            <button className="hover:bg-gray-50 flex items-center justify-center px-4 py-2 text-sm font-semibold text-gray-500 bg-white border border-gray-300 rounded-md shadow-sm">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
